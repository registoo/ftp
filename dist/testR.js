...
/*!************************!*\
  !*** ./src/files.json ***!
  \************************/
/*! exports provided: files, qw, Новая папка, default */
/***/ (function(module) {

module.exports = {"files":["index.html","mysite.css","testR.js","testR.js.map"],"qw":{"files":["qw\\q.q"]},"Новая папка":{"files":["Новая папка\\asdfghjkl.txt","Новая папка\\test.txt"],"New folder":{"files":["Новая папка\\New folder\\1.txt","Новая папка\\New folder\\mov_bbb.mp4"],"kakaya-to papka":{"files":["Новая папка\\New folder\\new f\\beirlbrvierbverbvjkerv.ww"]}},"old folder":{"files":["Новая папка\\old folder\\test.q"]}}};
...
var files = __webpack_require__(/*! ./files.json */ "./src/files.json");
...
function FTPfiles(props) {
  ...
  var arr = Object.getOwnPropertyNames(props.startDir);

  if (arr.length == 0) {
    return null;
  }

  var a = arr.map(function (elem, id) {
    if (elem === "files") {
      return null;
    }

    return React.createElement(DirFile, {
      dirName: elem,
      dirObj: props.startDir[elem],
      key: id
    });
  });
  return a;
...
function (_React$Component) {
  _inherits(DirFile, _React$Component);

  function DirFile(props) {
    var _this;

    _classCallCheck(this, DirFile);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(DirFile).call(this, props));
    _this.state = {
      filesButton: true
    };
    return _this;
  ...
  _createClass(DirFile, [{
    ...
    value: function render() {
      return React.createElement("div", null, this.fu());
    }
  }]);
...
function FilesFromButton(props) {
  ...
  return React.createElement("div", null, React.createElement(FTPfiles, {
